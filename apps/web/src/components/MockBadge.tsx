...
export function MockBadge() {
  ...
  return (
    <div
      ...
      className="pointer-events-none fixed bottom-3 left-3 z-[90] flex items-center gap-1.5 rounded-full bg-ink px-3 py-1.5 text-caption font-semibold tracking-[.12em] text-gold shadow-card"
    >
