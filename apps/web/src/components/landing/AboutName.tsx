...
const PARTS = [
  {
    word: "내가",
    title: "조건은 내가 정해요",
    body: "어디서 · 몇 명이서 · 얼마로 · 어떤 약속인지. 하루의 틀은 쓰는 사람이 정합니다.",
    chips: ["홍대", "2명", "50,000원", "데이트"],
  },
  {
    word: "짠",
    title: "예산 안에서 짠, 맞춰요",
    body: "아끼는 짠, 짜는 짠, 그리고 결과가 짠 하고 나오는 순간. 실제 장소로 예산을 넘지 않게 조합합니다.",
    chips: ["식사 22,000", "카페 6,000", "산책 무료", "놀거리 14,000"],
  },
  {
    word: "데이",
    title: "하루 전체가 나와요",
    body: "장소 하나가 아니라 먹고 · 걷고 · 쉬고 · 노는 하루의 순서. 남은 돈까지 영수증 한 장으로.",
