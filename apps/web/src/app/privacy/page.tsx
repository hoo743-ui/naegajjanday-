          ...
          <table>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>본 페이지 주소, 들어온 사이트 이름, 기기 종류(모바일 · PC), 이 브라우저의 임의 번호(해시로만 저장), 로그인한 경우 계정</td>
                <td>날짜별 이용자 수를 세어 서비스를 고치기 위해 (외부 분석 업체로 보내지 않아요)</td>
              </tr>
            </tbody>
          </table>
        </div>
  ...
  },
  {
    ...
    body: (
      <ul>
        ...
        <li>페이지 방문 기록: 최대 1년 보관한 뒤 자동으로 지워요.</li>
  ...
  },
  {
    ...
    body: (
      <ul>
        ...
        <li>
          이용 통계는 외부 도구 없이 직접 세요: 브라우저 저장소에 임의 번호 하나(<code>njd.visitor</code>)를 두고, 페이지를 볼 때 그 번호를 서버로 보내요. 서버는 번호를 되돌릴 수 없는 해시로만 저장하고, IP 는 남기지 않아요. 브라우저 저장소를 지우면 새 번호가 돼요.
        </li>
